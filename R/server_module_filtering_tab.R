...
#' @param type The type of filtering tab ("samples_filtering" or "features_filtering")
#'
...
server_module_filtering_tab <- function(id, step_number, type) {
    moduleServer(id, function(input, output, session) {
        ...
        server_module_qc_metrics("pre_vis", assays_to_process)
        ...
        entire_condition <- reactive({
            ...
            } else if (type == "samples_filtering") {
                res <- lapply(seq_len(n_boxes()), function(index) {
        ...
        server_module_qc_metrics("filt_vis", processed_assays)
