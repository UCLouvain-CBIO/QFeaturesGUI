#' @title interface for the filtering tab
#'
...
#'
interface_module_filtering_tab <- function(id, type) {
    tagList(
        actionButton(
            NS(id, "reload"),
        ...
        fluidRow(
            box(
                ...
                solidHeader = TRUE,
                collapsible = TRUE,
                interface_module_qc_metrics(NS(id, "pre_vis"), type)
            )
        ),
        fluidRow(
            box(
        ...
        fluidRow(
            box(
                ...
                solidHeader = TRUE,
                collapsible = TRUE,
                interface_module_qc_metrics(NS(id, "filt_vis"), type)
            )
        ),
        actionButton(
            NS(id, "export"),
