        ...
        lapply(seq_along(global_rv$workflow_config), function(i) {
            output[[paste0("dynamic_step_ui_", i)]] <- renderUI({
                switch(global_rv$workflow_config[[i]],
                    "Samples Filtering"     = interface_module_samples_filtering_tab(paste0("samples_filtering_", i)),
                    "Features Filtering"    = interface_module_features_filtering_tab(paste0("features_filtering_", i)),
            ...
            switch(global_rv$workflow_config[[i]],
                "Samples Filtering"     = server_module_samples_filtering_tab(paste0("samples_filtering_", i), step_number = i),
                "Features Filtering"    = server_module_features_filtering_tab(paste0("features_filtering_", i), step_number = i),
